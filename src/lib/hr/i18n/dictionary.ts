...
const en: Dict = {
  ...
  "balance.panelTitle": "Leave balances",
  "balance.panelIntro":
    "What this person has left this year. The balance is the sum of every recorded movement — there is no stored total, so it cannot drift.",
  "balance.remaining": "remaining",
  "balance.allowance": "Allowance",
  "balance.taken": "Taken",
  "balance.adjustTitle": "Adjust balance",
  "balance.adjustIntro":
    "Changes only this person's balance. Every adjustment is recorded with your name and reason, and appears in the history below.",
  "balance.leaveType": "Leave type",
  "balance.action": "What are you doing?",
  "balance.actionAdd": "Add days",
  "balance.actionDeduct": "Deduct days",
  "balance.actionSet": "Set the exact remaining balance",
  "balance.actionAllowance": "Change their yearly allowance",
  "balance.actionAddHint": "Earned or accrued leave to give them.",
  "balance.actionDeductHint": "Days to take off their balance.",
  "balance.actionSetHint":
    "The balance they should end up with. We record the difference.",
  "balance.actionAllowanceHint":
    "Their entitlement for the year. This does NOT change their remaining balance.",
  "balance.days": "Days",
  "balance.newAllowance": "New yearly allowance",
  "balance.effectiveDate": "Effective date",
  "balance.effectiveHint": "When this takes effect. Recorded in the history.",
  "balance.reason": "Reason",
  "balance.reasonHint": "Required. This is recorded against the employee permanently.",
  "balance.apply": "Save adjustment",
  "balance.applying": "Saving…",
  "balance.previewNoChange": "No change — that is the current value.",
  "balance.previewBalance": "Balance: {before} → {after}",
  "balance.previewAllowance": "Allowance: {before} → {after}",
  "balance.previewAllowanceNote": "The remaining balance does not change.",
  "balance.historyTitle": "Adjustment history",
  "balance.historyIntro":
    "Every manual change to this person's balance, newest first. Approvals and cancellations are recorded separately.",
  "balance.historyEmpty": "No manual adjustments have been made.",
  "balance.historyBy": "by {name}",
  "balance.colDate": "Effective",
  "balance.colChange": "Change",
  "balance.colAfter": "Balance after",
  "balance.colReason": "Reason",
  "balance.colBy": "Recorded by",
...
const vi: Dict = {
  ...
  "balance.panelTitle": "Số ngày phép",
  "balance.panelIntro":
    "Số ngày người này còn lại trong năm. Số dư là tổng của mọi biến động đã ghi nhận — không có con số lưu sẵn nên không thể sai lệch.",
  "balance.remaining": "còn lại",
  "balance.allowance": "Định mức",
  "balance.taken": "Đã dùng",
  "balance.adjustTitle": "Điều chỉnh số ngày phép",
  "balance.adjustIntro":
    "Chỉ thay đổi số ngày của riêng người này. Mọi điều chỉnh đều ghi lại tên bạn và lý do, và hiển thị trong lịch sử bên dưới.",
  "balance.leaveType": "Loại nghỉ",
  "balance.action": "Bạn muốn làm gì?",
  "balance.actionAdd": "Cộng thêm ngày",
  "balance.actionDeduct": "Trừ bớt ngày",
  "balance.actionSet": "Đặt chính xác số ngày còn lại",
  "balance.actionAllowance": "Đổi định mức phép năm",
  "balance.actionAddHint": "Số ngày phép tích lũy hoặc thưởng thêm.",
  "balance.actionDeductHint": "Số ngày cần trừ khỏi số dư của họ.",
  "balance.actionSetHint": "Số dư cuối cùng bạn muốn họ có. Hệ thống ghi lại phần chênh lệch.",
  "balance.actionAllowanceHint":
    "Định mức phép trong năm của họ. Việc này KHÔNG thay đổi số ngày còn lại.",
  "balance.days": "Số ngày",
  "balance.newAllowance": "Định mức phép năm mới",
  "balance.effectiveDate": "Ngày hiệu lực",
  "balance.effectiveHint": "Thời điểm áp dụng. Được ghi vào lịch sử.",
  "balance.reason": "Lý do",
  "balance.reasonHint": "Bắt buộc. Nội dung này được lưu vĩnh viễn với hồ sơ nhân viên.",
  "balance.apply": "Lưu điều chỉnh",
  "balance.applying": "Đang lưu…",
  "balance.previewNoChange": "Không thay đổi — đây đã là giá trị hiện tại.",
  "balance.previewBalance": "Số dư: {before} → {after}",
  "balance.previewAllowance": "Định mức: {before} → {after}",
  "balance.previewAllowanceNote": "Số ngày còn lại không thay đổi.",
  "balance.historyTitle": "Lịch sử điều chỉnh",
  "balance.historyIntro":
    "Mọi thay đổi thủ công đối với số ngày phép của người này, mới nhất trước. Duyệt đơn và hủy đơn được ghi riêng.",
  "balance.historyEmpty": "Chưa có điều chỉnh thủ công nào.",
  "balance.historyBy": "bởi {name}",
  "balance.colDate": "Hiệu lực",
  "balance.colChange": "Thay đổi",
  "balance.colAfter": "Số dư sau",
  "balance.colReason": "Lý do",
  "balance.colBy": "Người thực hiện",
